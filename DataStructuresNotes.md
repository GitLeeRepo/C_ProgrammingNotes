...
* **Node** - the node provides the basis of many data structures, such as linked lists.  It contains data and provides a means of connecting to other nodes through object data pointers (typical names for these pointers are Next, Prev, Head, Tail).
